...
public:
  ...
  //virtual void events2Callback(const EventsVector& events) = 0;
  ...
  virtual void pointcloud2Callback(const PointCloudVector& pointclouds, Time t) = 0;
  virtual void pointcloudeventsCallback(const EventsVector& events,const PointCloudVector& pointclouds, Time ) = 0;
